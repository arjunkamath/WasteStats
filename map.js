...
/*  var polyline = L.polyline([], {color: 'red'}).addTo(map);
  ...
  for (var i=0; i< route_to_kerava.length; i++){
    setTimeout(function(){
      polyline.addLatLng(route_to_kerava[i]);
    }, 300); 
  }
